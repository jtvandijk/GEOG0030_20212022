...
You can access the Lecturecast recording here: [[Link]](https://echo360.org.uk/section/9991b6b4-5c6b-4edd-aa84-7ff49b1170e3/home). The slides for this week's lecture can be downloaded here: [[Link]](https://github.com/jtvandijk/GEOG0030/tree/master/data/ppt/w08_geo.pdf).
...
```{r 08-load-all-data, warnings=FALSE, message=FALSE, cache=TRUE, tidy=FALSE}
...
The main library to use when it comes to point pattern analysis in R is the `spatstat` library, developed by Baddeley, Rubak and Turner since **2005**. As their documentation states, `spatstat` "is a package for the statistical analysis of spatial data. Its main focus is the analysis of spatial patterns of points in two-dimensional space". According to its "Get Started with `spatstat`" documentation, "`spatstat` supports a very wide range of popular techniques for statistical analysis for spatial point patterns, including:
