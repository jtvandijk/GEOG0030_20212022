...
We now have our London bike theft and train stations ready for analysis - we just need to complete one last step of processing with this dataset - calculating **whether or not a bike theft occurs near to a train station or not**. As above, we can use both geometric operations or spatial queries to complete this analysis.
