...
```{r 04-var4, warnings=FALSE, message=FALSE, eval=FALSE}
...
```{r 04-names-help, warnings=FALSE, message=FALSE, eval=FALSE }
...
```{r 04-data-frame-edition-final, warnings=FALSE, message=FALSE}
# inspect
giss_df
```
...
Let us go ahead and give our script a **TITLE** - and maybe some additional information (substitute accordingly):
...
```{r 04-scr-lib, warnings=FALSE, message=FALSE}
...
This will be the most complicated section of code yo will come across today, and we will use some functions that you have not seen before..
...
```{r 04-bar-plot, warnings=FALSE, message=FALSE, echo=FALSE}
# barplot
