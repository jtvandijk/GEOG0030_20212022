...
```{r 04-var4, warnings=FALSE, message=FALSE, eval=FALSE, tidy=TRUE}
...
As you can see, the function will get or set the names of an object, with renaming occuring by using the following syntax: `names(x) <- value`
...
```{r 05-scr-title, warnings=FALSE, message=FALSE, cache=TRUE, tidy=TRUE}
...
```{r 05-oinstall-libs-all, warnings=FALSE, message=FALSE, cache=TRUE, eval=FALSE, tidy=TRUE}
# install libraries
...
```{r 06-map-some-data-4, warnings=FALSE, message=FALSE, cache=TRUE}
...
```{r 06-map-some-data-5, warnings=FALSE, message=FALSE, cache=TRUE}
# plot the outline of our London Wards first
tm_shape(london_outline) + tm_borders() + 
    # plot TfL station data in red
    tm_shape(london_stations) + tm_dots(col = "red") + 
...
```{r 06-map-some-data-3, warnings=FALSE, message=FALSE, cache=TRUE}
