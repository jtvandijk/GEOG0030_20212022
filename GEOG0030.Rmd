...
# select column 2
dplyr::selectlsoa_ward_lookup, 2)

# select everything but column 2
dplyr::selectlsoa_ward_lookup, -2)

#select LSOA11CD column, note no ""
dplyr::selectlsoa_ward_lookup, LSOA11CD)

# select everything but column 2, note no ""
dplyr::selectlsoa_ward_lookup, -LSOA11CD)

# select LSOA* columns
dplyr::selectlsoa_ward_lookup, starts_with("LSOA"))
...
all_theft_ward_df_speedy_2 <- dplyr::selectlsoa_ward_lookup, LSOA11CD, WD18CD, WD18NM) %>% right_join(all_theft_df, by = c( "LSOA11CD" = "lsoa_code"))
``` 
